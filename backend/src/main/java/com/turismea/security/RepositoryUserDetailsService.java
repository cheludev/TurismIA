...
public class RepositoryUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        roles.add(new SimpleGrantedAuthority("ROLE_" + Role.ADMIN));
        roles.add(new SimpleGrantedAuthority("ROLE_" + Role.MODERATOR));
        roles.add(new SimpleGrantedAuthority("ROLE_" + Role.TOURIST));
